...
__author__ = 'sondos,shanqual and gabby'

__reference__ = "https://geektechstuff.com/2018/03/04/where-is-the-international-space-station-python/"
...
def indiana_time():
    ...
    location_indy.write(time.ctime(over_indy), font=('Arial', 6, 'bold'))
